...
```
$ http POST localhost:8099 username=admin password=admin 
```
...
```
$ http GET 'http://localhost:8099/users/?fromUsername=&usersPerPage=10' Authorization:"Bearer <TOKEN>"
```
The following would get users from testUser, with 10 per page.
```
$ http GET 'http://localhost:8099/users/?fromUsername=testUser&usersPerPage=2' Authorization:"Bearer <TOKEN>"
```
