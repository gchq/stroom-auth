...
interface ShowSearchLoaderAction extends Action<'tokenSearch/SHOW_SEARCH_LOADER'> {
...
interface ChangeLastUsedPageSizeAction extends Action<'tokenSearch/CHANGE_LAST_USED_PAGE_SIZE'> {
   lastUsedPageSize: Number; 
} ;
interface ChangeLastUsedPageAction extends Action<'tokenSearch/CHANGE_LAST_USED_PAGE'> {
   lastUsedPage: Number; 
} ;
interface ChangeLastUsedSortedAction extends Action<'tokenSearch/CHANGE_LAST_USED_SORTED'> {
   lastUsedSorted: String; 
} ;
interface ChangeLastUsedFilteredAction extends Action<'tokenSearch/CHANGE_LAST_USED_FILTERED'> {
...
export const useActionCreators = genUseActionCreators({
    ...
    updateResults: (results:Token[], totalPages: Number): UpdateResultsAction => ({
        type: UPDATE_RESULTS,
        results,
        totalPages
    }),
    ...
    changeLastUsedPageSize: (lastUsedPageSize:Number): ChangeLastUsedPageSizeAction => ({
    ...
    changeLastUsedSorted: (lastUsedSorted:String): ChangeLastUsedSortedAction => ({
        type: CHANGE_LAST_USED_SORTED,
        lastUsedSorted
    }),
    changeLastUsedFiltered: (lastUsedFiltered:String): ChangeLastUsedFilteredAction => ({
