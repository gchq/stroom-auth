...
public class AuthenticationApiTest {
    ...
    public void changePasswordTest() throws ApiException {
        ...
        String response = api.changePassword(id, body);
     ...
     */
    @Test
    public void getIdTokenTest() throws ApiException {
        String accessCode = null;
        String response = api.getIdToken(accessCode);
    ...
    public void handleAuthenticationRequestTest() throws ApiException {
        ...
        String state = null;
        String response = api.handleAuthenticationRequest(clientId, redirectUrl, nonce, scope, responseType, state);
