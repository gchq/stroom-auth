...
export const userServiceUrl = () => {
  return `${process.env.REACT_APP_AUTH_SERVICE}/user/v1`
}

export const tokenServiceUrl = () => {
  return `${process.env.REACT_APP_AUTH_SERVICE}/token/v1`
}
...
export const stroomUrl = () => {
  return process.env.REACT_APP_STROOM_URL
}
