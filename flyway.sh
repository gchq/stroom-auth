...
./gradlew -Pflyway.user=stroomuser -Pflyway.password=stroompassword1 -Pflyway.url=jdbc:mariadb://localhost:3309/auth -Pflyway.locations=filesystem:stroom-auth-svc/src/main/resources/db/migration flyway$1
