...
public class JsonWebKey extends TableImpl<JsonWebKeyRecord> {
    ...
    private static final long serialVersionUID = -1643771914;
    ...
    /**
     * The column <code>auth.json_web_key.create_time_ms</code>.
     */
    public final TableField<JsonWebKeyRecord, Long> CREATE_TIME_MS = createField("create_time_ms", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
