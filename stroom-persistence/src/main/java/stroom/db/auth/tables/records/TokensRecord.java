...
public class TokensRecord extends UpdatableRecordImpl<TokensRecord> implements Record10<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String> {

    private static final long serialVersionUID = -1002517489;
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String> valuesRow() {
     ...
     */
    @Override
    public TokensRecord values(Integer value1, Integer value2, Integer value3, String value4, Timestamp value5, Timestamp value6, Integer value7, Boolean value8, Timestamp value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TokensRecord(Integer id, Integer userId, Integer tokenTypeId, String token, Timestamp expiresOn, Timestamp issuedOn, Integer issuedByUser, Boolean enabled, Timestamp updatedOn, String updatedByUser) {
        super(Tokens.TOKENS);
