...
public class TokensRecord extends UpdatableRecordImpl<TokensRecord> implements Record11<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String, String> {

    private static final long serialVersionUID = 1099880433;
     ...
     */
    @Override
    public Row11<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row11<Integer, Integer, Integer, String, Timestamp, Timestamp, Integer, Boolean, Timestamp, String, String> valuesRow() {
     ...
     */
    @Override
    public TokensRecord value10(String value) {
     ...
     */
    @Override
    public TokensRecord values(Integer value1, Integer value2, Integer value3, String value4, Timestamp value5, Timestamp value6, Integer value7, Boolean value8, Timestamp value9, String value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TokensRecord(Integer id, Integer userId, Integer tokenTypeId, String token, Timestamp expiresOn, Timestamp issuedOn, Integer issuedByUser, Boolean enabled, Timestamp updatedOn, String updatedByUser, String comments) {
        super(Tokens.TOKENS);
