...
public class TokensRecord extends UpdatableRecordImpl<TokensRecord> implements Record10<Integer, Integer, Integer, String, Timestamp, Timestamp, String, Boolean, Timestamp, String> {

    private static final long serialVersionUID = 902813434;
     ...
     */
    public void setIssuedByUser(String value) {
        set(6, value);
    }
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, String, Timestamp, Timestamp, String, Boolean, Timestamp, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, Integer, Integer, String, Timestamp, Timestamp, String, Boolean, Timestamp, String> valuesRow() {
     ...
     */
    @Override
    public TokensRecord values(Integer value1, Integer value2, Integer value3, String value4, Timestamp value5, Timestamp value6, String value7, Boolean value8, Timestamp value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TokensRecord(Integer id, Integer userId, Integer tokenTypeId, String token, Timestamp expiresOn, Timestamp issuedOn, String issuedByUser, Boolean enabled, Timestamp updatedOn, String updatedByUser) {
        super(Tokens.TOKENS);
