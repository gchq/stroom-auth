...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<TokensRecord, UsersRecord> FK_ISSUED_TO = Internal.createForeignKey(stroom.db.auth.Keys.KEY_USERS_PRIMARY, Tokens.TOKENS, "fk_issued_to", Tokens.TOKENS.USER_ID);
        public static final ForeignKey<TokensRecord, TokenTypesRecord> FK_TOKEN_TYPE_ID = Internal.createForeignKey(stroom.db.auth.Keys.KEY_TOKEN_TYPES_PRIMARY, Tokens.TOKENS, "fk_token_type_id", Tokens.TOKENS.TOKEN_TYPE_ID);
        public static final ForeignKey<TokensRecord, UsersRecord> FK_ISSUED_BY_USER = Internal.createForeignKey(stroom.db.auth.Keys.KEY_USERS_PRIMARY, Tokens.TOKENS, "fk_issued_by_user", Tokens.TOKENS.ISSUED_BY_USER);
        public static final ForeignKey<TokensRecord, UsersRecord> FK_UPDATED_BY_USER = Internal.createForeignKey(stroom.db.auth.Keys.KEY_USERS_PRIMARY, Tokens.TOKENS, "fk_updated_by_user", Tokens.TOKENS.UPDATED_BY_USER);
    }
}
